...
def test_api_v1_status():
    ...
    # A2.3 + A2.4 + A2.5 + A2.6 + A3.2-A3.4 + A4.2-A4.3 + A4.5 + A4.7 已实现
    ...
    assert data["modules"]["sight_reading"] is True
    assert data["modules"]["feedback"] is True
    # 其它还没做
    for module in ["senior_mode", "subscription"]:
